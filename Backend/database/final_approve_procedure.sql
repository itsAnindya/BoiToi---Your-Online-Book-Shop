-- Minimal fix for ApproveBookRequest to include author processing
-- This only adds the missing author handling without changing existing logic
...
BEGIN
    ...
    ELSE
        ...
        ELSE
            ...
            -- ONLY ADDITION: Process authors after book creation
