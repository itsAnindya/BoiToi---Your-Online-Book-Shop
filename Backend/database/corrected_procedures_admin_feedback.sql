-- Updated stored procedures - Fix rejection reason to go to admin_feedback
-- The rejection reason should be stored as admin_feedback, not in separate fields
...
-- ===========================
-- STORED PROCEDURE: REJECT BOOK REQUEST - REJECTION REASON GOES TO ADMIN_FEEDBACK
-- ===========================
...
BEGIN
    ...
    ELSE
        ...
        ELSE
            ...
            -- Update request status - REJECTION REASON GOES TO ADMIN_FEEDBACK
            UPDATE PUBLISHER_REQUEST 
            SET STATUS = 'REJECTED',
                REVIEWED_AT = NOW(),
                REVIEWED_BY = admin_id,
