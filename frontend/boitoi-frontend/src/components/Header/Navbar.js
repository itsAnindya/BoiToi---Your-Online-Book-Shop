          ...
          {isAuthenticated ? (
            <ul class="nav-bar">
              ...
              >
                ...
                ></i>
                <div className="navbar-brand" style={{ color: "white", fontSize: "20px", padding: "10px" }}><BookOpen size={24} color="White" />BoiToi</div>
              </Link>
            ...
            <ul class="nav-bar">
              ...
              >
                ...
                ></i>
                {/* <BookOpen size={24} /> */}
                <div className="flex items-center gap-2" style={{ display: "inline-flex", color: "white", fontSize: "20px", padding: "10px", gap: "0.5rem", alignItems: "center" }}>
                  {/* icon */}
              ...
              <span class="menu">
                ...
                <li>
                  <div className="flex justify-center items-center" style={{padding: "8px", display: "inline-flex", alignItems: "center", justifyContent: "center", gap: "8px" }}>
                    <SearchBar />
                  </div>
                </li>
                <li>
