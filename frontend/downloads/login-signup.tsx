...
import { Book, User, Mail, Phone, Calendar, MapPin, Home, Building } from 'lucide-react';
          ...
          {isLogin ? (
            ...
            <>
              ...
              <button
                ...
                className="w-full bg-gradient-to-r from-purple-500 to-blue-500 text-white py-4 rounded-xl font-semibold hover:from-purple-600 hover:to-blue-600 transform hover:scale-105 transition-all duration-300 shadow-lg"
              >
                Login to BoiToi
              </button>
            </>
